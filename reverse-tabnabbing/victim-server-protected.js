 ...
 *   http://localhost:3018  ← protected (rel="noopener noreferrer")
 */
...
function sharedStyles() {
  return `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .demo-banner.noopener-noreferrer {
      background: #dcfce7;
      border-bottom: 2px solid #16a34a;
      color: #166534;
    }
...
<body>
  <div class="demo-banner noopener-noreferrer">✅ NOOPENER + NOREFERRER: Tabnabbing blocked AND Referer header suppressed — external site receives no information about where you came from.</div>
  ${buildHeader()}
  <main>
    ...
    <article class="article-card" style="max-width: 520px;">
      <h2>
        <a href="http://localhost:${ATTACKER_PORT}/article" target="_blank" rel="noopener noreferrer nofollow">
          How AI Is Reshaping Frontend Development
        </a>
        <span class="external-badge">↗ External</span>
      </h2>
      ...
      -->
      <a href="http://localhost:${ATTACKER_PORT}/article" target="_blank" rel="noopener noreferrer nofollow" class="read-link">
        Read Full Article →
      </a>
    </article>

    <div class="referer-safe">
      <strong>✅ What the external site will receive when you click:</strong>
      <code>Referer: (none — header suppressed by rel="noreferrer")</code>
...
app.listen(PORT, function () {
  console.log('TechBlog (PROTECTED) running at http://localhost:' + PORT);
});
