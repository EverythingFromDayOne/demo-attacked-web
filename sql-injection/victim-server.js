/*
 * Terminal 1: cd demo-attacked/sql-injection && npm install && npm run vulnerable
 * Attack guide: npm run guide → http://localhost:3026
 */
...
function buildAdminDashboardPage() {
  ...
  return buildPageShell({
    ...
    navActive: 'admin',
    banner:
      '<div class="demo-banner injected">' +
...
app.listen(PORT, function () {
  console.log('DevLinks (VULNERABLE) running at http://localhost:' + PORT);
});
