/*
 * Terminal 1: cd demo-attacked/nosql-injection && npm install && npm run victim
...
<body>
  <div class="top-banner vulnerable">
  ...
  // Allow operator injection: if the typed value is valid JSON (e.g. {"$gt":""}),
  // parse it into an object so it's sent as a nested structure, not a string.
  let password;
...
<body>
  <div class="top-banner injected">
    🚨 ACCESS GRANTED — You are viewing the full user registry.<br>
