...
function sharedCss() {
  return `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .input-note { color: #94a3b8; font-size: 0.78rem; margin: -0.5rem 0 1rem; }
...
<body>
  ...
  <div id="app-view" class="hidden">
    <div class="demo-banner">
      ✅ PROTECTED: execFile() with hostname allowlist — no shell invoked
    </div>
    <header class="topbar">
      <div class="logo"><span>Net</span>Probe</div>
      <div class="topbar-right">
        <span class="security-badge">🛡 Command Injection Protected</span>
    ...
    <div class="layout">
      ...
      <main class="main">
        <div class="tool-card" id="tool-ping">
          ...
          <p class="input-note">Input validated — hostname characters only. Requests run via execFile(), not exec().</p>
        ...
        <div class="tool-card hidden" id="tool-http">
          ...
          <p class="input-note">URL must be http:// or https://. Requests run via execFile(), not exec().</p>
